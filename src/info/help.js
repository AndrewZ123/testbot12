...
module.exports = {
    ...
    run: (client, message) => {
        const embed0 = new Discord.MessageEmbed()
            ...
            .setColor(0x5126c7)
            .setThumbnail(`https://www.wolflair.com/wp-content/uploads/2017/01/placeholder.jpg`)
            .setDescription(`Hello <@${message.author.id}>, please familiarize yourself with this bot by reading over this embed!\n\n`)
            .setImage(`https://www.wolflair.com/wp-content/uploads/2017/01/placeholder.jpg`)
